      ...
      <form className="shipping-settings-form" onSubmit={save}>
        <section>
          ...
          <div className="shipping-form-grid">
            ...
            <Field label="Phone" value={settings.phone} onChange={(value) => update("phone", value)} required />
            <Field label="Email" type="email" value={settings.email} onChange={(value) => update("email", value)} required />
            <p className="shipping-contact-note wide">USPS requires both fields when postage is purchased. Use a real 10-digit phone number.</p>
          </div>
        </section>
