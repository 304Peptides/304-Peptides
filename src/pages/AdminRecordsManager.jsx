...
const ORDER_SEARCH_SESSION_KEY = "304-order-manager-search";
const CUSTOMER_SEARCH_SESSION_KEY = "304-customer-manager-search";

function readAndClearSessionSearch(key) {
  try {
    const value =
...
function storeSessionSearch(key, value) {
  try {
...
function AdminRecordsManager({
  ...
  const pageDescription =
    showOrders
      ? "Manage protected orders, invoices, payments, fulfillment, shipping labels, tracking, cancellations, and private order records."
      : "Review registered customer accounts, order-history summaries, account access, password recovery, suspensions, and active sessions.";
  ...
  const [accountsLoading, setAccountsLoading] = useState(
    Boolean(adminSecret && showAccounts)
  );
  ...
  const [orderSearch, setOrderSearch] = useState(() =>
    readAndClearSessionSearch(
      ORDER_SEARCH_SESSION_KEY
    )
  );
  const [statusFilter, setStatusFilter] = useState("all");
  const [accountSearch, setAccountSearch] = useState(() =>
    readAndClearSessionSearch(
      CUSTOMER_SEARCH_SESSION_KEY
    )
  );
  ...
  const accountOrderSummaries = useMemo(() => {
    const summaries =
      new Map();
      ...
      <>
        ...
        <main className="cm-page">
          <section className="cm-login">
            ...
            <p>
              {showOrders
                ? "Enter your administrator secret to open protected order operations."
                : "Enter your administrator secret to open protected customer-account and recovery tools."}
            </p>
      ...
      <main className="cm-page">
        <section className="cm-wrap">
            ...
            >
              <strong>
                {showOrders
                  ...
                  : "Customer order summaries could not be loaded."}
              </strong>
            ...
            {accountsLoading ? (
              ...
              <div className="cm-account-grid">
                {filteredAccounts.map((account) => {
                  ...
                  const orderSummary =
                    accountOrderSummaries.get(email) || {
                      count: 0,
                      value: 0,
                      lastOrder: null,
                    };
                          ...
                          value={
                            orderSummary.lastOrder
                              ? `#${getOrderId(
                                  ...
                                  orderSummary.lastOrder.createdAt ||
                                    orderSummary.lastOrder.updatedAt ||
                                    orderSummary.lastOrder.date
                                )}`
                              : "No orders"
                          }
                        />
                        ...
                        <div className="cm-details">
                          ...
                          <div>
                            ...
                            <p>
                              ...
                              {order.policyAcceptance?.version ||
                                "Not recorded"}
                            </p>
                            ...
                            <p>
                              ...
                              {formatDate(
                                order.policyAcceptance?.acceptedAt
                              )}
                            </p>
                            ...
                            <p>
                              ...
                              {formatDate(
                                order.policyAcceptance?.clientAcceptedAt
                              )}
                            </p>
                            ...
                            <p>
                              ...
                              {order.policyAcceptance?.researchUseAccepted === true
                                ? "Confirmed"
                                : "Not recorded"}
                            </p>
                            ...
                            <p>
                              ...
                              {order.policyAcceptance?.age21Confirmed === true
                                ? "Confirmed"
                                : "Not recorded"}
                            </p>
                          </div>
          ...
          <section className="cm-security-note">
            ...
            <p>
              {showOrders
                ? "Cloudflare Access protects the admin route, and every order, invoice, payment, fulfillment, shipping, tracking, cancellation, and deletion request still requires the administrator bearer secret."
                : "Cloudflare Access protects the admin route, and every account-directory, recovery, suspension, reactivation, and session-control request still requires the administrator bearer secret. Password hashes and password salts are never returned to this page."}
            </p>
          </section>
        </section>
      </main>
...
export default AdminRecordsManager;